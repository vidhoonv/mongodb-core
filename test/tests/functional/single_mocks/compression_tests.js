...
describe('Single Compression (mocks)', function() {
  it('server should recieve list of client\'s supported compressors in handshake', {
    ...
    test: function(done) {
      ...
      setTimeout(function() { client.connect(); }, 100);
    }
  });

  it('should connect and insert document when server is responding with OP_COMPRESSED with no compression', {
    metadata: {
      requires: {
        generators: true,
        topology: 'single'
  ...
  it('should connect and insert document when server is responding with OP_COMPRESSED with snappy compression', {
    metadata: {
      requires: {
        generators: true,
        topology: 'single'
  ...
  it('should connect and insert document when server is responding with OP_COMPRESSED with zlib compression', {
    metadata: {
      requires: {
        generators: true,
        topology: 'single'
