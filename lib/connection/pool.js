...
Pool.prototype.connect = function() {
  ...
  connection.once('connect', function(connection) {
    ...
    // Azure CosmosDB replicaset configuration does not have
    // any ARBITER replicas. And, we require every connection
    // including the ones used in topology monitoring to be authenticated
    // before it impacts the topology view of client.
    // Hence commenting out this special handling on client driver
    // to handle auth against an arbiter in replicaset.
    /*
